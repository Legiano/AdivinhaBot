...
function exibirTextoNaTela(tag, texto) {
    ...
    // usando essa API para narrar um texto.
...
function exibirMensagemInicial() {
    ...
    exibirTextoNaTela('p', 'Digite um número entre 1 e 10 para começar o jogo.');
}
...
function verificarChute() {
    ...
    if (chute == numeroSecreto) {
        ...
        let mensagemTentativas = `Parabéns,você descobriu o número secreto, 
